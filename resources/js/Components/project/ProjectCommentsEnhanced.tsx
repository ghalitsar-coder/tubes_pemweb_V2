...
export function ProjectCommentsEnhanced({
    projectId,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(`/api/projects/${projectId}/comments`, formData, {
            headers: {
                "Content-Type": "multipart/form-data",
            },
            onSuccess: (response: any) => {
                const newComment = response.props?.comment || {
                    id: Date.now(),
    ...
    const handleReply = (commentId: number) => {
        ...
        setData({ ...data, parent_id: commentId });
    };
    ...
    const handleDelete = (commentId: number) => {
        ...
        router.delete(`/api/projects/${projectId}/comments/${commentId}`, {
            onSuccess: () => {
